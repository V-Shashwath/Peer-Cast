...
export default function InviteCode({ port }) {
  ...
  return (
    <div className="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
      ...
      <p className="text-sm text-green-600 mb-3">Share this invite code with others:</p>
      ...
      <p className="mt-3 text-xs text-gray-500">Code valid while your session is active.</p>
    </div>
  );
}
